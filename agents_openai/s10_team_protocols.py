...
"""
s10_team_protocols.py - Team Protocols (OpenAI format)
...
OBSERVER = create_observer(agent_name="s10_team_protocols", model=MODEL)
...
# request_id -> {"target" | "from", ... "status": "pending|approved|rejected"}
    ...
    def _teammate_loop(self, name: str, role: str, prompt: str):
        ...
        for _ in range(50):
            ...
            for tool_call in assistant.tool_calls:
                ...
                if tool_call.function.name == "shutdown_response" and bool(tool_input.get("approve")):
                    should_exit = True
