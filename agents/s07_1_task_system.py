...
"""
s07_1_task_system.py - Tasks + Delete
...
TOOLS = [
    ...
    {"name": "task_delete", "description": "Delete a task and clean dependency references. By default only completed tasks can be deleted.",
     "input_schema": {"type": "object", "properties": {"task_id": {"type": "integer"}, "force": {"type": "boolean"}}, "required": ["task_id"]}},
]
